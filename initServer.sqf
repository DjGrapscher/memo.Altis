...
fnc_s_sys_gebaeudeauswahl = compile preprocessfilelinenumbers "alex_funktionen\fnc_s_sys_gebaeudeauswahl.sqf";
fnc_s_sys_positionen_innerhalb_haus = compile preprocessfilelinenumbers "alex_funktionen\fnc_s_sys_positionen_innerhalb_haus.sqf";
...
fnc_s_sys_wasser_zwischen_a_und_b = compile preprocessfilelinenumbers "alex_funktionen\fnc_s_sys_wasser_zwischen_a_und_b.sqf";
fnc_s_sys_winkel_pos1_zu_pos2 = compile preprocessfilelinenumbers "alex_funktionen\fnc_s_sys_winkel_pos1_zu_pos2.sqf";
...
if ((s_missions_aktiv) && {! isnil "s_sys_area_hq"}) then {
  ...
  _scriptaufruf = [] execVM "alex_missions\memo_fast_response\init_fr_server.sqf"; waituntil {scriptdone _scriptaufruf};
  //_scriptaufruf = [] execVM "alex_missions\mibu_liberty\init_mili_server.sqf"; waituntil {scriptdone _scriptaufruf};
  _scriptaufruf = [] execVM "alex_missions\memo_witek_deluxe\init_dmd_server.sqf"; waituntil {scriptdone _scriptaufruf};
  //_scriptaufruf = [] execVM "alex_missions\blaecki_geburtstag\init_bgeb_server.sqf"; waituntil {scriptdone _scriptaufruf};
  _scriptaufruf = [] execVM "alex_missions\heavy_load_hc\init_hlhc_server.sqf"; waituntil {scriptdone _scriptaufruf};
  _scriptaufruf = [] execVM "alex_missions\verteidigung\init_server.sqf"; waituntil {scriptdone _scriptaufruf};
  ...
  _scriptaufruf = [] execVM "alex_missions\verteidigung_zombie\init_server.sqf"; waituntil {scriptdone _scriptaufruf};
  _scriptaufruf = [] execVM "alex_missions\rettung_z\init_server.sqf"; waituntil {scriptdone _scriptaufruf};
