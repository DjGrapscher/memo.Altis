...
systemchat "Suche Haeuser....";
{
  ...
  //_haeuser_area1 = [((_x select 1) select 0), 80, _DEF_min_anz_geb_positionen_in_loc_zivilist] call fnc_s_sys_gebaeudeauswahl;
  {
  ...
  } foreach ([((_x select 1) select 0), 80, _DEF_min_anz_geb_positionen_in_loc_zivilist] call fnc_s_sys_gebaeudeauswahl);
