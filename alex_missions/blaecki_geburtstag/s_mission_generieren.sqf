...
private _alle_haeuser = [_loc_area1 select 0, _loc_area1 select 1,s_bgeb_min_gebaeudepositionen] call fnc_s_sys_gebaeudeauswahl;
...
while {_anz_feinde_haus > 0} do {
  ...
  _positionen_im_haus = [_haus] call fnc_s_sys_positionen_innerhalb_haus;
