...
private _haeuser = [_pos_rel,_dist_min/10,_DEF_pos_im_haus_min] call fnc_s_sys_gebaeudeauswahl;
if ((count _haeuser) == 0) exitwith {[]};
private _positionen_im_haus = [selectrandom _haeuser] call fnc_s_sys_positionen_innerhalb_haus;
